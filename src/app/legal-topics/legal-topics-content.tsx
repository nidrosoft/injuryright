...
function HeroSection() {
  ...
  return (
    <section
      ref={ref}
      className="relative pt-32 pb-8 sm:pt-40 sm:pb-12 bg-gradient-to-b from-blue-50 to-white"
    >
      <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.h1
            variants={fadeInUp}
            className="mt-4 text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 leading-tight"
          >
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
          ...
          <div className="relative sm:w-48">
            <select
              ...
              className="w-full px-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none cursor-pointer"
            >
...
function TabsSection({
  ...
  activeTab: "questions" | "guides";
  setActiveTab: (tab: "questions" | "guides") => void;
    ...
    <section className="bg-white border-b border-gray-200">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="flex gap-8">
          ...
          >
            <MessageChatCircle className="w-4 h-4" />
            Questions & Answers
    ...
    <div className="bg-white border border-gray-200 rounded-xl p-5 hover:shadow-md transition-shadow">
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1">
          <span className={cx(
            "inline-block px-2.5 py-1 rounded text-xs font-medium mb-3",
            item.category === "question" 
              ? "bg-orange-100 text-orange-700" 
              : "bg-blue-100 text-blue-700"
          )}>
            {item.category === "question" ? "Question" : "Guide"}
          </span>

          <Link href={`/legal-topics/${item.id}`} className="block group">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-xs text-gray-500">
            <span>Asked in {item.location}</span>
            <span>{item.date}</span>
            {item.answers > 0 && (
              <Link href={`/legal-topics/${item.id}`} className="text-blue-600 hover:underline">
        ...
        <button className="hidden sm:flex items-center gap-1 text-xs text-gray-500 hover:text-blue-600 transition-colors">
        ...
        >
          {items.length > 0 ? (
            ...
            <div className="text-center py-12 text-gray-500">
              No {activeTab === "questions" ? "questions" : "guides"} found matching your search.
            </div>
          )}
        </motion.div>
      </div>
    ...
    <section ref={ref} className="py-16 bg-white">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          initial="hidden"
          animate={inView ? "visible" : "hidden"}
          className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 sm:p-12 text-center"
        >
          <motion.h2
            variants={fadeInUp}
...
export function LegalTopicsPageContent() {
  ...
  const filteredQuestions = questionsData.filter((q) => {
    ...
    const matchesState =
      ...
      q.location.includes(selectedState.split(" ")[0]);
  ...
  const filteredGuides = legalGuides.filter((g) => {
    ...
    const matchesState =
      selectedState === "All States" ||
      g.location === "All States" ||
      g.location.includes(selectedState.split(" ")[0]);
    return matchesSearch && matchesState;
  });
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "QAPage",
            name: "Legal Resources - Questions & Answers",
            description: "Get answers to common personal injury law questions from real cases across the United States.",
